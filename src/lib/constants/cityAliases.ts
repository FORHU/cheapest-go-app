...
export const CITY_ALIASES: Record<string, Record<string, string>> = {
    ...
    CA: {
        ...
        'tofino village': 'Tofino', 'ucluelet': 'Ucluelet',
        ...
        // Quebec extras
        'old quebec city': 'Quebec City', 'petit champlain': 'Quebec City',
        'basse-ville': 'Quebec City', 'haute-ville': 'Quebec City',
    ...
    AR: {
        ...
        'viedma city': 'Viedma', 'rawson chubut': 'Rawson', 'trelew city': 'Trelew',
        // Northern Argentina extras
        'humahuaca quebrada': 'Humahuaca', 'iruya village': 'Iruya',
        // Mesopotamia
        'corrientes city': 'Corrientes', 'posadas city': 'Posadas',
        'resistencia chaco': 'Resistencia', 'formosa city': 'Formosa',
        // Buenos Aires Province
        'la plata city': 'La Plata', 'quilmes city': 'Quilmes', 'lanus city': 'Lanús',
        'moron city': 'Morón', 'merlo buenos aires': 'Merlo', 'san isidro argentina': 'San Isidro',
        'san fernando argentina': 'San Fernando', 'pilar buenos aires': 'Pilar',
    },
    CL: {
        ...
        'valle del elqui': 'Vicuña', 'pisco elqui': 'Pisco Elqui', 'vicuna city': 'Vicuña',
        ...
        'frutillar town': 'Frutillar', 'llanquihue lake': 'Llanquihue', 'puerto octay': 'Puerto Octay',
        // Easter Island
        'easter island': 'Hanga Roa', 'hanga roa': 'Hanga Roa', 'rapa nui': 'Hanga Roa',
        // Aysen / Patagonia
        'coyhaique city': 'Coyhaique (und Umgebung)', 'cochrane chile': 'Cochrane', 'caleta tortel': 'Caleta Tortel',
        'villa o higgins': 'Villa O\'Higgins',
        // Chiloé extras
        'dalcahue': 'Dalcahue', 'quemchi': 'Quemchi', 'achao chiloe': 'Achao',
        // Central Valley
    ...
    CO: {
        ...
        'lorica colombia': 'Lorica', 'covenas beach': 'Coveñas',
        'san onofre beach': 'San Onofre', 'tolu beach': 'Tolú',
        // Pacific coast
        'bahia solano': 'Bahía Solano', 'buenaventura city': 'Buenaventura',
        'guapi city': 'Guapi', 'tumaco city': 'Tumaco',
        // Amazon
        'leticia amazon': 'Leticia', 'puerto narino': 'Puerto Narino',
        // Llanos / Casanare
        'yopal city': 'Yopal', 'villavicencio city': 'Villavicencio',
        'granada meta': 'Granada', 'acacias meta': 'Acacias',
        // More inland cities
        ...
        'ibague city': 'Ibague', 'espinal tolima': 'Espinal',
    ...
    PE: {
        ...
        // Puno extras
        'juli puno': 'Juli', 'pomata lake': 'Pomata', 'ilave puno': 'Ilave',
        // Amazon
        'nauta loreto': 'Nauta', 'requena loreto': 'Requena', 'yurimaguas': 'Yurimaguas',
        // Northern coast
        'mancora beach': 'Máncora (und Umgebung)', 'los organos beach': 'Los Organos', 'vichayito beach': 'Vichayito',
        'zorritos tumbes': 'Zorritos', 'tumbes city': 'Tumbes',
        // Southern coast
        'camana arequipa': 'Camaná', 'mollendo beach': 'Mollendo', 'matarani port': 'Islay',
        // Highlands extras
        ...
        'piura city': 'Piura', 'catacaos piura': 'Catacaos',
        'lambayeque city': 'Lambayeque', 'sipan museum': 'Lambayeque',
        // Junin / Central
        'huancayo city': 'Huancayo', 'tarma city': 'Tarma', 'la oroya': 'La Oroya',
        'junin lake': 'Junín', 'cerro de pasco': 'Cerro de Pasco',
    },
    EC: {
    ...
    UY: {
        ...
        // More Uruguay cities
        'jose ignacio': 'Jose Ignacio', 'punta del diablo': 'Punta del Diablo',
        'rocha uruguay': 'Rocha', 'maldonado uy': 'Maldonado',
        'pan de azucar': 'Pan de Azúcar', 'treinta y tres': 'Treinta y Tres',
        'mercedes uruguay': 'Mercedes', 'paysandu': 'Paysandú',
        'fray bentos': 'Fray Bentos', 'canelones': 'Canelones',
        'las piedras uy': 'Las Piedras', 'san jose de mayo': 'San José de Mayo',
        'florida uruguay': 'Florida', 'minas uy': 'Minas',
        'melo uruguay': 'Melo', 'rivera uruguay': 'Rivera',
        'tacuarembo': 'Tacuarembó', 'artigas uy': 'Artigas',
    },
    // ── Europe ─────────────────────────────────────────────────────────────────
    GB: {
    ...
    PT: {
        ...
        // Azores extras
        'flores azores': 'Santa Cruz das Flores', 'corvo azores': 'Corvo',
    ...
    GR: {
        ...
        'milos island': 'Milos', 'plaka milos': 'Milos', 'adamas': 'Milos',
        ...
        'larissa city': 'Larissa', 'volos city': 'Volos', 'pelion peninsula': 'Volos',
        'kalamata city': 'Kalamata', 'sparta city': 'Sparta',
        'olympia ruins': 'Ancient Olympia', 'nafplio city': 'Nafplio',
        ...
        'parga city': 'Parga', 'preveza city': 'Preveza',
        'katakolon': 'Pyrgos',
    },
    CZ: {
    ...
    PL: {
        ...
        'szczecin city': 'Stettin', 'bydgoszcz': 'Bydgoszcz',
        ...
        'rzeszow city': 'Rzeszow', 'kielce city': 'Kielce',
        ...
        // More Polish cities
        'radom city': 'Radom', 'sosnowiec city': 'Sosnowiec', 'gliwice city': 'Gliwice',
        'zabrze city': 'Zabrze', 'bytom city': 'Bytom', 'rybnik city': 'Rybnik',
        'czestochowa city': 'Tschenstochau',
        'opole city': 'Opole', 'gorzow wielkopolski': 'Landsberg',
    ...
    IL: {
        ...
        'dead sea israel': 'Ein Bokek', 'ein bokek': 'Ein Bokek',
        'masada fortress': 'Ein Bokek', 'masada': 'Ein Bokek',
        ...
        'hadera city': 'Hadera', 'zichron yaakov': 'Zichron Yaakov',
        ...
        'jericho': 'Jericho', 'ramallah': 'Ramallah', 'bethlehem': 'Bethlehem',
        'nablus': 'Nablus', 'hebron': 'Hebron',
    ...
    JO: {
        ...
        'العقبة': 'Akaba', 'إربد': 'Irbid', 'الزرقاء': 'Zarqa',
    ...
    MA: {
        ...
        'safi morocco': 'Safi', 'el kelaa des sraghna': 'Kelaat Sraghna',
        ...
        'settat': 'Settat', 'berrechid': 'Berrechid',
        ...
        'saida morocco': 'Saida', 'guercif': 'Guercif',
    ...
    VN: {
        ...
        'lang co': 'Lang Co', 'hai van pass': 'Lang Co',
        ...
        'soc trang': 'Soc Trang', 'bac lieu': 'Bac Lieu',
        'ca mau': 'Ca Mau',
        ...
        'mu cang chai': 'Mu Cang Chai', 'tu le': 'Mu Cang Chai',
        'tam duong': 'Tam Duong',
        ...
        // South Coast
        'vung tau city': 'Vung Tàu', 'phan rang': 'Phan Rang', 'ninh chu beach': 'Phan Rang',
        ...
        'điện biên phủ': 'Dien-Bien-Phu', 'mù cang chải': 'Mu Cang Chai',
        'việt nam': 'Hanoi',
    },
    ID: {
        // Bali
        ...
        'kedewatan': 'Kedewatan', 'tegalalang': 'Tegalalang', 'kerobokan': 'Kerobokan',
        ...
        'bintan': 'Bintan', 'lagoi': 'Bintan', 'tanjung pinang': 'Tanjung Pinang',
        // Kalimantan
        ...
        'banda islands': 'Banda Neira', 'banda neira': 'Banda Neira',
        // Raja Ampat
        ...
        'donggala': 'Palu',
        // Maluku more areas
        'ternate': 'Ternate', 'tidore': 'Tidore', 'tidore island': 'Tidore',
        'tual': 'Tual',
        // Papua / West Papua
        ...
        // Nusa Tenggara
        'kupang': 'Kupang', 'rote island': 'Ba a', 'nemberala': 'Ba a',
    ...
    IN: {
        ...
        'bundi fort': 'Bundi', 'tonk rajasthan': 'Tonk',
        ...
        'modhera': 'Mehsana', 'ambaji': 'Banaskantha',
        // More Himachal
        'tirthan valley': 'Kullu', 'jibhi': 'Kullu',
        'barot': 'Mandi', 'prashar lake': 'Mandi',
        'kinnaur kailash': 'Rampur', 'kalpa': 'Rampur',
        'tabo monastery': 'Kaza', 'dhankar': 'Kaza',
        // More Uttarakhand
        'tehri lake': 'Tehri', 'tehri': 'Tehri',
        'chopta rhododendron': 'Ukhimath', 'deoria tal': 'Ukhimath',
        'kausani': 'Kausani', 'bageshwar': 'Bageshwar',
        'champawat': 'Champawat', 'almora': 'Almora',
        'ranikhet': 'Ranikhet',
        // More Bihar / Jharkhand
        'gaya city': 'Gaya', 'pawapuri': 'Nalanda',
        'deoghar': 'Deoghar', 'dumka': 'Dumka',
        'hazaribagh': 'Hazaribagh', 'bokaro': 'Bokaro',
        // More North East
        'tawang': 'Tawang', 'bomdila': 'Bomdila',
        'ziro valley': 'Ziro', 'along': 'Aalo',
        'silchar': 'Silchar', 'diphu': 'Diphu',
        'ukhrul': 'Ukhrul', 'mon nagaland': 'Mon',
        'champhai': 'Champhai', 'aizawl city': 'Aizawl',
        // More Andhra / Telangana
        'srisailam': 'Nandyal', 'lepakshi': 'Hindupur',
        'warangal': 'Warangal', 'nizamabad': 'Nizamabad',
        'khammam': 'Khammam',
        // Odisha extras
        'cuttack': 'Cuttack', 'berhampur': 'Berhampur',
        'sambalpur': 'Sambalpur', 'brahmapur': 'Berhampur',
        'koraput': 'Koraput', 'jeypore odisha': 'Jeypore',
        // More Madhya Pradesh
        'sanchi': 'Raisen', 'bandhavgarh': 'Umaria',
    ...
    AU: {
        ...
        'mornington peninsula': 'Mornington', 'mornington': 'Mornington', 'portsea': 'Mornington',
    ...
    NZ: {
        ...
        'stewart island': 'Halfmoon Bay', 'halfmoon bay': 'Halfmoon Bay',
        'oban stewart island': 'Halfmoon Bay',
    ...
    PH: {
        ...
        'boac': 'Boac',
        // Batanes Islands
        'batan island': 'Batanes', 'basco batanes': 'Batanes', 'ivana': 'Batanes',
        'sabtang': 'Batanes',
        ...
        'tinglayan': 'Tinglayan', 'kalinga tribe': 'Tinglayan',
        ...
        'samboan': 'Samboan', 'alcoy cebu': 'Alcoy', 'alegria cebu': 'Alegria',
        ...
        'malapascua island': 'Malapascua', 'daanbantayan': 'Daanbantayan',
        'camotes islands': 'Camotes', 'san francisco camotes': 'Camotes', 'poro camotes': 'Camotes',
        'toledo cebu': 'Toledo',
        'danao cebu': 'Danao',
        'naga cebu': 'Naga',
        'barili cebu': 'Barili',
        ...
        // Bohol extras
        'tubigon': 'Tubigon', 'ubay bohol': 'Ubay',
        'inabanga': 'Inabanga', 'bien unido': 'Bien Unido', 'danajon bank': 'Bien Unido',
        ...
        'culion': 'Culion', 'linapacan': 'Linapacan',
        'roxas palawan': 'Roxas',
        'dumaran': 'Dumaran', 'calauit island': 'Busuanga',
        // Negros Occidental
        'sipalay': 'Sipalay', 'sugar beach negros': 'Sipalay', 'punta ballo': 'Sipalay',
        'sagay negros': 'Sagay', 'sagay marine reserve': 'Sagay', 'carbin reef': 'Sagay',
        'san carlos negros': 'San Carlos', 'cadiz negros occidental': 'Cadiz',
        'escalante city': 'Escalante', 'manapla': 'Cadiz',
        // Negros Oriental extras
        'mabinay': 'Mabinay', 'mabinay caves': 'Mabinay',
        'bayawan': 'Bayawan', 'guihulngan': 'Guihulngan',
        // Leyte / Samar extras
        'maasin city': 'Maasin', 'maasin southern leyte': 'Maasin',
        'baybay leyte': 'Baybay', 'hilongos leyte': 'Hilongos', 'sogod leyte': 'Sogod',
        ...
        'marawi': 'Marawi', 'lake lanao': 'Marawi',
        ...
        'ozamiz': 'Ozamiz City', 'ozamiz city': 'Ozamiz City',
        'oroquieta': 'Oroquieta',
        'gingoog': 'Gingoog',
        ...
        'los banos': 'Los Baños', 'los baños': 'Los Baños', 'uplb campus': 'Los Baños',
        'bay laguna': 'Bay', 'calauan laguna': 'Calauan',
        'pagsanjan': 'Pagsanjan', 'pagsanjan falls': 'Pagsanjan',
        'sta cruz laguna': 'Santa Cruz', 'santa cruz laguna': 'Santa Cruz',
        'biñan': 'Biñan', 'binan laguna': 'Biñan',
        ...
        'calatagan beach': 'Calatagan', 'matabungkay beach': 'Matabungkay',
        // Quezon province extras
        'tayabas': 'Tayabas', 'sariaya': 'Sariaya', 'gumaca quezon': 'Gumaca',
        'atimonan': 'Atimonan', 'infanta quezon': 'Infanta', 'real quezon': 'Real',
        'dingalan aurora': 'Dingalan',
        // More Surigao / Caraga
        'hinatuan enchanted river': 'Hinatuan', 'hinatuan surigao': 'Hinatuan',
        'dinagat islands': 'San Jose',
        // Agusan
        'prosperidad': 'Prosperidad', 'agusan del sur': 'Prosperidad',
        'bayugan': 'Bayugan',
        // More Pampanga
        'angeles city pampanga': 'Angeles', 'porac pampanga': 'San Fernando',
        'floridablanca': 'San Fernando', 'guagua pampanga': 'San Fernando',
        // Mindoro extras
        'mamburao': 'Mamburao', 'occidental mindoro': 'Mamburao',
        // Aklan / Antique extras
        'tibiao antique': 'Tibiao', 'antique province': 'San Jose de Buenavista',
        ...
        'sarangani province': 'Alabel', 'glan sarangani': 'Glan',
        'lake holon': 'Lake Sebu', 'lake maughan': 'Lake Sebu',
        // More CDO / Misamis
        'jasaan misamis oriental': 'Jasaan', 'el salvador misamis': 'El Salvador',
        // North Cotabato
        'kabacan': 'Kabacan', 'magpet': 'Magpet',
        ...
        'kawit cavite': 'Kawit', 'cavite city': 'Cavite City',
        ...
        'amadeo cavite': 'Amadeo', 'carmona cavite': 'Carmona',
        ...
        'bocaue bulacan': 'Bocaue', 'marilao bulacan': 'Marilao',
        'obando bulacan': 'Obando', 'pandi bulacan': 'Pandi',
        'norzagaray': 'Norzagaray', 'san miguel bulacan': 'San Miguel',
        'hagonoy bulacan': 'Hagonoy', 'plaridel bulacan': 'Plaridel',
        'balagtas bulacan': 'Balagtas', 'guiguinto bulacan': 'Guiguinto',
        'sta maria bulacan': 'Santa Maria',
        // Rizal province extras
        'rodriguez rizal': 'Rodriguez', 'montalban': 'Rodriguez',
        'san mateo rizal': 'San Mateo', 'marikina valley': 'Marikina',
        'teresa rizal': 'Teresa', 'morong rizal': 'Morong',
        'cardona rizal': 'Cardona', 'pililla rizal': 'Pililla',
        'tanay rizal': 'Tanay', 'baras rizal': 'Baras',
        // Laguna extras
        ...
        'paete laguna': 'Paete', 'pakil laguna': 'Pakil',
        'majayjay laguna': 'Majayjay', 'siniloan laguna': 'Siniloan',
        // Pampanga province extras
        'mabalacat city': 'Mabalacat', 'san simon pampanga': 'San Simon',
        'apalit pampanga': 'Apalit', 'macabebe pampanga': 'Macabebe',
        'masantol pampanga': 'Masantol', 'lubao pampanga': 'Lubao',
        'san luis pampanga': 'San Luis', 'candaba pampanga': 'Candaba',
        'bacolor pampanga': 'Bacolor', 'sta ana pampanga': 'Santa Ana',
        // Nueva Ecija extras
        'science city of munoz': 'Munoz', 'munoz nueva ecija': 'Munoz',
        'gapan nueva ecija': 'Gapan', 'palayan city': 'Palayan City',
        'san jose nueva ecija': 'San Jose',
        // Tarlac extras
        'capas tarlac': 'Capas', 'bamban tarlac': 'Bamban',
        'paniqui tarlac': 'Paniqui', 'camiling tarlac': 'Camiling',
        // Pangasinan extras
        'urdaneta pangasinan': 'Urdaneta', 'villasis pangasinan': 'Villasis',
        'san carlos pangasinan': 'San Carlos', 'tayug pangasinan': 'Tayug',
        'binmaley pangasinan': 'Binmaley', 'lingayen pangasinan': 'Lingayen',
        'mangatarem pangasinan': 'Mangatarem', 'aguilar pangasinan': 'Aguilar',
        // La Union / Ilocos extras
        'bauang la union': 'Bauang', 'agoo la union': 'Agoo',
        'aringay la union': 'Aringay', 'tubao la union': 'Tubao',
        'bacnotan la union': 'Bacnotan', 'naguilian la union': 'Naguilian',
        'candon ilocos sur': 'Candon',
        'narvacan ilocos sur': 'Narvacan', 'santa ilocos sur': 'Santa',
        'pasuquin ilocos norte': 'Pasuquin', 'adams ilocos norte': 'Adams',
        'vintar ilocos norte': 'Vintar', 'dingras ilocos norte': 'Dingras',
        'piddig ilocos norte': 'Piddig', 'solsona ilocos norte': 'Solsona',
        // Cagayan Valley
        'aparri cagayan': 'Aparri', 'abulug cagayan': 'Abulug',
        'gonzaga cagayan': 'Gonzaga', 'sta teresita cagayan': 'Santa Teresita',
        'lasam cagayan': 'Lasam', 'baggao cagayan': 'Baggao',
        'gattaran cagayan': 'Gattaran', 'tuao cagayan': 'Tuao',
        'ilagan isabela': 'Ilagan', 'cauayan isabela': 'Cauayan',
        'roxas isabela': 'Roxas', 'santiago isabela': 'Santiago',
        'santiago city': 'Santiago', 'diffun quirino': 'Diffun',
        'aurora quirino': 'Cabarroguis', 'maddela quirino': 'Maddela',
        'bambang nueva vizcaya': 'Bambang', 'bayombong nueva vizcaya': 'Bayombong',
        'solano nueva vizcaya': 'Solano',
        // Iloilo extras
        'oton iloilo': 'Oton', 'pototan iloilo': 'Pototan',
        'duenas iloilo': 'Duenas', 'barotac nuevo': 'Barotac Nuevo',
        'barotac viejo': 'Barotac Viejo', 'san enrique iloilo': 'San Enrique',
        'passi city': 'Passi', 'jordan guimaras': 'Jordan',
        'guimaras island': 'Jordan', 'buenavista guimaras': 'Buenavista',
        // Bacolod / Negros Occidental extras
        'talisay city negros': 'Talisay City', 'talisay negros occidental': 'Talisay City',
        'silay city': 'Silay', 'victorias negros': 'Victorias',
        'kabankalan city': 'Kabankalan', 'himamaylan city': 'Himamaylan',
        'murcia negros': 'Murcia', 'la carlota': 'La Carlota',
        'pontevedra negros': 'Pontevedra',
        // Bukidnon (Mindanao highlands)
        'malaybalay': 'Malaybalay', 'malaybalay city': 'Malaybalay',
        'valencia bukidnon': 'Valencia City', 'valencia city bukidnon': 'Valencia City',
        'impasugong': 'Impasugong', 'dole pineapple bukidnon': 'Manolo Fortich',
        'manolo fortich': 'Manolo Fortich', 'del monte bukidnon': 'Manolo Fortich',
        'maramag bukidnon': 'Maramag', 'kibawe bukidnon': 'Kibawe',
        'don carlos bukidnon': 'Don Carlos', 'quezon bukidnon': 'Quezon',
        // Misamis Occidental extras
        'tangub city': 'Tangub City', 'jimenez misamis occidental': 'Jimenez',
        'plaridel misamis occidental': 'Plaridel',
        'calamba misamis occidental': 'Calamba',
        // Misamis Oriental extras
        'initao': 'Initao', 'opol misamis oriental': 'Opol',
        'villanueva misamis': 'Villanueva', 'laguindingan': 'Laguindingan',
        // South Cotabato extras
        'surallah': 'Surallah', 'banga south cotabato': 'Banga',
        'norala south cotabato': 'Norala', 'sto nino south cotabato': 'Santo Niño',
        'polomolok': 'Polomolok', 't boli': 'T\'Boli',
        // Sultan Kudarat
        'isulan sultan kudarat': 'Isulan', 'tacurong sultan kudarat': 'Tacurong',
        'lebak sultan kudarat': 'Lebak', 'lambayong sultan kudarat': 'Lambayong',
        // Compostela Valley / Davao de Oro
        'compostela valley': 'Nabunturan', 'nabunturan': 'Nabunturan',
        'montevista': 'Montevista', 'pantukan': 'Pantukan',
        'new bataan comval': 'New Bataan', 'mawab comval': 'Mawab',
        // Davao del Norte extras
        'carmen davao del norte': 'Carmen', 'new corella davao': 'New Corella',
        'kapalong': 'Kapalong', 'talaingod': 'Talaingod',
        // Davao Occidental
        'jose abad santos': 'Jose Abad Santos', 'malita davao': 'Malita',
        'sta maria davao del sur': 'Santa Maria',
        // Davao Oriental
        'mati davao oriental': 'Mati', 'mati city': 'Mati',
        'manay davao oriental': 'Manay', 'tarragona davao oriental': 'Tarragona',
        'cateel davao oriental': 'Cateel', 'baganga davao oriental': 'Baganga',
        // Sarangani
        'alabel sarangani': 'Alabel', 'malapatan sarangani': 'Malapatan',
        'maitum sarangani': 'Maitum', 'kiamba sarangani': 'Kiamba',
        // Agusan del Norte
        'cabadbaran city': 'Cabadbaran',
        'las nieves agusan': 'Las Nieves', 'nasipit agusan': 'Nasipit',
        // Surigao del Sur
        'tandag surigao del sur': 'Tandag', 'cantilan surigao del sur': 'Cantilan',
        'lanuza surigao del sur': 'Lanuza', 'lianga surigao': 'Lianga',
        // Surigao del Norte extras
        'del carmen surigao': 'Del Carmen', 'alegria surigao norte': 'Alegria',
        ...
        'mabini batangas': 'Mabini', 'tingloy batangas': 'Tingloy',
        'san pascual batangas': 'San Pascual', 'laurel batangas': 'Laurel',
        'agoncillo batangas': 'Agoncillo', 'alitagtag batangas': 'Alitagtag',
        'balete batangas': 'Balete', 'cuenca batangas': 'Cuenca',
        'san luis batangas': 'San Luis', 'talaga': 'Talaga',
        // Albay extras (Bicol)
        'ligao albay': 'Ligao', 'ligao city': 'Ligao',
        'tabaco albay': 'Tabaco', 'tabaco city': 'Tabaco',
        'tiwi albay': 'Tiwi', 'jovellar albay': 'Jovellar',
        'mayon volcano': 'Legazpi', 'daraga albay': 'Legazpi',
        // Camarines Norte
        'daet camarines norte': 'Daet', 'daet': 'Daet',
        'camarines norte': 'Daet', 'labo camarines norte': 'Labo',
        // Camarines Sur
        'pili camarines sur': 'Pili', 'calabanga': 'Calabanga',
        'tinambac': 'Tinambac', 'goa camarines sur': 'Goa',
        'san jose camarines sur': 'San Jose', 'iriga city': 'Iriga',
        'nabua camarines sur': 'Nabua', 'baao camarines sur': 'Baao',
        // Quezon province extras
        'padre burgos quezon': 'Padre Burgos', 'catanauan quezon': 'Catanauan',
        'plaridel quezon': 'Plaridel', 'macalelon quezon': 'Macalelon',
        'pitogo quezon': 'Pitogo', 'calauag quezon': 'Calauag',
        'mulanay quezon': 'Mulanay',
        // Marinduque extras
        'torrijos marinduque': 'Torrijos', 'buenavista marinduque': 'Buenavista',
        // Romblon province extras
        'odiongan romblon': 'Odiongan', 'cajidiocan romblon': 'Cajidiocan',
        'san agustin romblon': 'San Agustin', 'sibuyan island': 'Magdiwang',
        'magdiwang romblon': 'Magdiwang',
        // Ifugao extras (Cordillera)
        'lagawe ifugao': 'Lagawe', 'lamut ifugao': 'Lamut',
        'hingyon ifugao': 'Hingyon', 'aguinaldo ifugao': 'Aguinaldo',
        // Kalinga extras
        'tabuk kalinga': 'Tabuk', 'rizal kalinga': 'Rizal',
        'pinukpuk kalinga': 'Pinukpuk',
        // Mountain Province extras
        'bontoc town': 'Bontoc', 'besao mountain province': 'Besao',
        'sabangan mountain province': 'Sabangan', 'tadian mountain province': 'Tadian',
        // Benguet extras
        'tublay benguet': 'Tublay', 'kapangan benguet': 'Kapangan',
        'kibungan benguet': 'Kibungan', 'atok benguet': 'Atok',
        'kabayan benguet': 'Kabayan', 'buguias benguet': 'Buguias',
        // Apayao
        'luna apayao': 'Luna', 'kabugao apayao': 'Kabugao',
        // Abra extras
        'lagangilang abra': 'Lagangilang', 'tayum abra': 'Tayum',
        'pidigan abra': 'Pidigan', 'dolores abra': 'Dolores',
        ...
        'cabarroguis quirino': 'Cabarroguis', 'bagabag nueva vizcaya': 'Bayombong',
        ...
        'narvacan ilocos sur alt': 'Narvacan', 'bantay ilocos sur': 'Vigan',
        'sta catalina negros oriental': 'Santa Catalina',
        'sta barbara iloilo': 'Santa Barbara',
        'mina iloilo': 'Mina', 'lemery iloilo': 'Lemery',
        'tubungan iloilo': 'Tubungan', 'tigbauan iloilo': 'Tigbauan',
        // Catanduanes Island (not previously covered)
        'virac': 'Virac', 'virac catanduanes': 'Virac', 'catanduanes island': 'Virac',
        'pandan catanduanes': 'Pandan Catanduanes', 'gigmoto catanduanes': 'Gigmoto',
        'viga catanduanes': 'Viga', 'bagamanoc catanduanes': 'Bagamanoc',
        ...
        'monreal masbate': 'Monreal',
        // Tawi-Tawi (southernmost province)
        'bongao': 'Bongao', 'bongao tawi-tawi': 'Bongao', 'tawi-tawi': 'Bongao',
        'sapa-sapa': 'Sapa-Sapa', 'tandubas': 'Tandubas',
        'turtle islands': 'Turtle Islands',
        // Sulu
        'jolo': 'Jolo', 'jolo sulu': 'Jolo', 'sulu province': 'Jolo',
        'patikul': 'Patikul', 'indanan': 'Indanan',
        // Basilan
        'isabela city basilan': 'Isabela City', 'basilan': 'Isabela City',
        'lamitan': 'Lamitan', 'lamitan city': 'Lamitan',
        // Kalanggaman Island (Leyte — famous sandbar)
        'kalanggaman island': 'Palompon', 'palompon leyte': 'Palompon',
        // Biliran extras
        'biliran island': 'Naval', 'almeria biliran': 'Almeria', 'kawayan biliran': 'Kawayan',
        'cabucgayan biliran': 'Cabucgayan', 'caibiran biliran': 'Caibiran',
        // Itbayat (Batanes northernmost island)
        'itbayat': 'Itbayat', 'itbayat batanes': 'Itbayat',
        // Guimaras extras
        'nueva valencia guimaras': 'Nueva Valencia', 'san lorenzo guimaras': 'San Lorenzo',
        'sibunag guimaras': 'Sibunag',
        // Palawan extras
        'narra palawan': 'Narra', 'quezon palawan': 'Quezon',
        'rio tuba': 'Bataraza', 'bataraza palawan': 'Bataraza',
        'brooke point': "Brooke's Point", 'sofronio espanola': 'Sofronio Española',
        // More Davao del Sur
        'digos city extras': 'Digos', 'hagonoy davao del sur': 'Hagonoy',
        'padada davao del sur': 'Padada',
        // Lanao del Sur
        'marawi city': 'Marawi', 'malabang lanao del sur': 'Malabang',
        'wao lanao del sur': 'Wao', 'sultan naga dimaporo': 'Lanao del Norte',
        // More Zamboanga Sibugay
        'kabasalan': 'Kabasalan', 'talusan zamboanga sibugay': 'Talusan',
        // More Aurora province
        'baler aurora': 'Baler', 'aurora province': 'Baler',
        'casiguran aurora': 'Casiguran', 'dinalungan aurora': 'Dinalungan',
        // More Nueva Vizcaya
        'kasibu nueva vizcaya': 'Kasibu', 'dupax nueva vizcaya': 'Dupax del Norte',
        // More Quirino
        'nagtipunan quirino': 'Nagtipunan',
        // More Ilocos Norte
        ...
        // Kalinga extras
        'balbalan kalinga': 'Balbalan', 'lubuagan kalinga': 'Lubuagan',
        'tanudan kalinga': 'Tanudan',
        // Cebu City extras
    ...
    BD: {
        ...
        'ময়মনসিংহ': 'Mymensingh', 'রংপুর': 'Rangpur', 'বাংলাদেশ': 'Dhaka',
    ...
    LK: {
        ...
        'beruwala': 'Beruwala', 'kalutara': 'Kalutara',
    ...
    PK: {
        ...
        'kalam': 'Bahrain', 'bahrain swat': 'Bahrain',
        ...
        'mastuj': 'Chitrãl', 'phander': 'Ghizer',
        'gupis': 'Ghizer', 'ghizer': 'Ghizer',
        'khyber pass': 'Peshawar', 'torkham': 'Peshawar',
        'dir pakistan': 'Dir', 'timergara': 'Dir',
        'shangla': 'Alpuri',
        // AJK / Azad Kashmir
        'muzaffarabad': 'Muzaffarabad', 'mirpur ajk': 'Mirpur',
        'neelum valley': 'Muzaffarabad', 'ratti gali': 'Muzaffarabad',
        'sharda ajk': 'Sharda', 'keran ajk': 'Muzaffarabad',
        'rawalakot': 'Rawala Kot', 'bagh ajk': 'Bagh',
        // Sindh extras
        'sukkur': 'Sukkur', 'larkana': 'Larkana',
        'mohenjo daro': 'Larkana', 'moenjodaro': 'Larkana',
        'thatta': 'Thatta', 'makli necropolis': 'Thatta',
        'nawabshah': 'Nawabshah', 'mirpur khas': 'Mirpur Khas',
        'khairpur': 'Khairpur',
        // Balochistan extras
        'ziarat': 'Ziarat',
        'gwadar': 'Gwãdar', 'gwadar port': 'Gwãdar',
        'turbat': 'Turbat', 'khuzdar': 'Khuzdar',
        'hub balochistan': 'Hub',
    ...
    NP: {
        ...
        // Remote destinations
        'rara lake': 'Jumla', 'rara national park': 'Jumla',
    ...
    SE: {
        ...
        'abisko': 'Abisko', 'jokkmokk': 'Jokkmokk',
    },
    NO: {
        ...
        'svalbard': 'Longyearbyen', 'longyearbyen': 'Longyearbyen', 'spitsbergen': 'Longyearbyen',
        // Trondheim extras
    ...
    RO: {
        ...
        'vaslui': 'Vaslui', 'focsani': 'Focsani', 'galati': 'Galati',
    ...
    HR: {
        ...
        'krapina croatia': 'Krapina', 'čakovec': 'Cakovec',
    ...
    BG: {
        ...
        'borovets ski': 'Borovets', 'pamporovo ski': 'Pamporovo',
    ...
    UA: {
        ...
        'zhytomyr city': 'Zhytomyr', 'vinnytsia': 'Winnyzja',
        'khmelnytskyi ukraine': 'Khmelnytskyi', 'rivne ukraine': 'Rovno',
        'uzhhorod': 'Ushhorod', 'ivano-frankivsk': 'Iwano-Frankiwsk',
        'ternopil ukraine': 'Ternopil', 'lutsk ukraine': 'Lutsk',
        'cherkasy ukraine': 'Cherkasy', 'kropyvnytskyi': 'Kropyvnytskyi',
        'bukovel ski resort': 'Jaremtsche', 'yaremche': 'Jaremtsche',
        'mukachevo': 'Mukachevo', 'kamianets-podilskyi': 'Kamjanez-Podilskyj',
    ...
    NG: {
        ...
        'jos city': 'Jos', 'zaria': 'Zaria', 'kaduna city': 'Kaduna',
        ...
        'anambra': 'Awka', 'awka': 'Awka', 'nnewi': 'Nnewi',
        'abakaliki': 'Abakaliki', 'orlu': 'Orlu', 'okigwe': 'Okigwe',
        'damaturu': 'Damaturu', 'gombe nigeria': 'Gombe', 'yola': 'Yola',
        'lafia nasarawa': 'Lafia', 'makurdi benue': 'Makurdi',
        'lokoja nigeria': 'Lokoja', 'anyigba': 'Anyigba',
    },
    GH: {
        ...
        // Other Ghana cities
        'takoradi': 'Takoradi', 'sekondi': 'Takoradi', 'cape coast': 'Cape Coast',
        'elmina': 'Cape Coast', 'tamale': 'Tamale', 'bolgatanga': 'Bolgatanga',
        'wa ghana': 'Wa', 'sunyani': 'Sunyani', 'koforidua': 'Koforidua',
        'ho ghana': 'Ho', 'hohoe': 'Hohoe',
        // More Ghana areas
        ...
        'prampram': 'Tema', 'assin fosu': 'Assin Fosu',
        'obuasi': 'Obuasi', 'ejisu': 'Kumasi', 'asante akyem': 'Kumasi',
        'techiman': 'Techiman', 'berekum': 'Berekum', 'kintampo': 'Kintampo',
        'nkawkaw': 'Nkawkaw', 'suhum': 'Suhum', 'nsawam': 'Nsawam',
        'kasoa': 'Kasoa', 'winneba': 'Winneba', 'saltpond': 'Saltpond',
        'takoradi beach': 'Takoradi', 'sekondi takoradi': 'Takoradi',
        'axim ghana': 'Axim', 'half assini': 'Half Assini',
    },
    TZ: {
        ...
        'serengeti': 'Serengeti', 'seronera': 'Serengeti',
        ...
        'pemba island tanzania': 'Chake Chake', 'chake chake': 'Chake Chake',
        'wete pemba': 'Wete', 'mkoani pemba': 'Mkoani',
    ...
    UG: {
        ...
        'queen elizabeth park': 'Kasese', 'kasese': 'Kasese', 'rwenzori': 'Kasese',
