...
export const CITY_ALIASES: Record<string, Record<string, string>> = {
    ...
    GH: {
        ...
        // Other Ghana cities
        'takoradi': 'Takoradi', 'sekondi': 'Takoradi', 'cape coast': 'Elmina',
        'elmina': 'Elmina', 'tamale': 'Tamale', 'bolgatanga': 'Bolgatanga',
        'wa ghana': 'Wa', 'sunyani': 'Sunyani', 'koforidua': 'Koforidua',
        'ho ghana': 'Ho', 'hohoe': 'Ho',
        // More Ghana areas
        ...
        'techiman': 'Techiman', 'berekum': 'Sunyani', 'kintampo': 'Techiman',
        'nkawkaw': 'Nkawkaw', 'suhum': 'Koforidua', 'nsawam': 'Accra',
        'kasoa': 'Kasoa', 'winneba': 'Winneba', 'saltpond': 'Winneba',
        'takoradi beach': 'Takoradi', 'sekondi takoradi': 'Takoradi',
        'axim ghana': 'Axim', 'half assini': 'Axim',
    },
    TZ: {
