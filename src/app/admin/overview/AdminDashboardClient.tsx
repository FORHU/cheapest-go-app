...
export default function AdminDashboardClient({ data }: AdminDashboardClientProps) {
    ...
    const [isSupplierCollapsed, setIsSupplierCollapsed] = useState(false);
        ...
        <div className="space-y-10 pb-20">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <motion.div
                    ...
                    className="lg:col-span-1 bg-white dark:bg-obsidian border border-slate-100 dark:border-white/10 p-8 rounded-[2rem] shadow-xl flex flex-col group transition-all duration-500"
                >
                    <div className={`flex items-center justify-between ${isSupplierCollapsed ? '' : 'mb-8'} relative z-10`}>
                        <div className="flex-1">
                            <div className="flex items-center justify-between gap-3">
                                ...
                                <button
                                    onClick={() => setIsSupplierCollapsed(!isSupplierCollapsed)}
                                    className="p-2 rounded-xl hover:bg-slate-50 dark:hover:bg-white/10 transition-colors text-slate-400"
                                >
                                    {isSupplierCollapsed ? <ChevronDown size={20} /> : <ChevronUp size={20} />}
                                </button>
                            </div>
                        </div>
                        {!isSupplierCollapsed && (
                ...
                <motion.div
                    ...
                    className="lg:col-span-2 bg-white dark:bg-obsidian border border-slate-100 dark:border-white/10 p-8 rounded-[2rem] shadow-xl flex flex-col group transition-all duration-500"
                >
                    <div className={`flex items-center justify-between ${isActivityCollapsed ? '' : 'mb-8'}`}>
                        <div className="flex-1">
                            <div className="flex items-center justify-between gap-3">
                                <div>
                                    <h3 className="text-xl font-black text-slate-900 dark:text-white transition-colors">Recent Activity</h3>
                                    {!isActivityCollapsed && <p className="text-xs font-bold text-slate-400 uppercase tracking-widest mt-1 transition-colors">Live Transaction Hub</p>}
                                </div>
                                <button
                    ...
                    <AnimatePresence>
                        {!isActivityCollapsed && (
                            ...
                            >
                                ...
                                <Button asChild variant="ghost" className="w-full mt-auto pt-8 text-slate-400 text-[10px] font-black uppercase tracking-[0.2em] border-t border-slate-100 dark:border-white/5 hover:bg-transparent hover:text-blue-600 transition-colors">
                                    <Link href="/admin/bookings">
                                        Enter Bookings Page
                                    </Link>
                                </Button>
                ...
                {/* Project Analytics Card (Now 1 col) */}
                <div className="lg:col-span-1">
