...
export function AccountContent({ initialUser }: AccountContentProps) {
    ...
    const sidebarItems = useMemo(() => [
        { id: 'profile', icon: <User size={20} />, title: t('nav.profile.title'), description: t('nav.profile.description') },
        { id: 'communications', icon: <Bell size={20} />, title: t('nav.communications.title'), description: t('nav.communications.description') },
        { id: 'security', icon: <Shield size={20} />, title: t('nav.security.title'), description: t('nav.security.description') },
        { id: 'help', icon: <HelpCircle size={20} />, title: t('nav.help.title'), description: t('nav.help.description') },
    ], [t]);
