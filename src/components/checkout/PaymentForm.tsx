        ...
        <div className="bg-white dark:bg-slate-900 rounded-lg lg:rounded-xl border border-slate-200 dark:border-white/10 p-3 lg:p-6 shadow-sm">
            ...
            <div className="flex gap-4 mb-3 lg:mb-6">
                <button className="flex-1 py-1.5 lg:py-3 text-[11px] lg:text-base border-2 border-blue-600 bg-blue-50 dark:bg-blue-900/20 text-blue-700 dark:text-blue-300 font-bold rounded lg:rounded-lg flex items-center justify-center gap-1.5 lg:gap-2">
                    <CreditCard className="w-3.5 h-3.5 lg:w-[18px] lg:h-[18px]" /> {t('payment.card')}
                </button>
            </div>
            ...
            <div className="space-y-2.5 lg:space-y-4">
                ...
                <div className="grid grid-cols-2 gap-2.5 lg:gap-4">
                    ...
                    <div>
                        <input
                            ...
                            placeholder={t('payment.securityCode')}
                        />
                ...
                {/* Country Dropdown */}
                <div>
                    <label className="block text-[9px] lg:text-xs font-bold uppercase text-slate-500 mb-0.5 lg:mb-1">{t('payment.country')}</label>
                    <select
                        name="cardCountry"
                ...
                <div className="grid grid-cols-2 gap-2.5 lg:gap-4">
                    <div>
                        <label className="block text-[9px] lg:text-xs font-bold uppercase text-slate-500 mb-0.5 lg:mb-1">{t('payment.payeeFirstName')}</label>
                        <input
                    ...
                    <div>
                        <label className="block text-[9px] lg:text-xs font-bold uppercase text-slate-500 mb-0.5 lg:mb-1">{t('payment.payeeLastName')}</label>
                        <input
                            value={payeeLastName}
