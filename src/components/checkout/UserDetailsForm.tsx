    ...
    return (
        <div className="bg-white dark:bg-slate-900 rounded-lg lg:rounded-xl border border-slate-200 dark:border-white/10 p-3 lg:p-6 shadow-sm">
            ...
            <div className="grid grid-cols-2 gap-2.5 lg:gap-4">
                ...
                <div>
                    <label className="block text-[9px] lg:text-xs font-bold uppercase text-slate-500 mb-0.5 lg:mb-1">Email *</label>
                    <input
                        name="email"
                ...
                <div>
                    <label className="block text-[9px] lg:text-xs font-bold uppercase text-slate-500 mb-0.5 lg:mb-1">Phone *</label>
                ...
                <div className="col-span-2 mt-1">
                    <label className="block text-[9px] lg:text-xs font-bold uppercase text-slate-500 mb-1 lg:mb-2">Traveling for work?</label>
                    <div className="flex flex-wrap gap-3 lg:gap-4">
                        <label className="flex items-center gap-1.5 lg:gap-2 cursor-pointer">
                            ...
                            />
                            <span className="text-[11px] lg:text-sm">Yes</span>
                        </label>
                        <label className="flex items-center gap-1.5 lg:gap-2 cursor-pointer">
                            <input
                                type="radio"
                                ...
                                className="w-3.5 h-3.5 lg:w-4 lg:h-4 text-blue-600"
                            />
                            <span className="text-[11px] lg:text-sm">No</span>
                        </label>
                    </div>
                </div>
            </div>
