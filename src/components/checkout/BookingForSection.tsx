                ...
                <div className="grid grid-cols-2 gap-2 lg:gap-4">
                    <div>
                        ...
                        <input
                            ...
                            type="text"
                            className={`w-full min-w-0 px-2 py-1.5 lg:p-3 text-[11px] lg:text-sm rounded lg:rounded-lg border bg-slate-50 dark:bg-white/5 outline-none focus:border-blue-500 ${errors.guestFirstName ? 'border-red-400' : 'border-slate-200 dark:border-white/10'}`}
                        />
                    ...
                    <div>
                        ...
                        <input
                            ...
                            onChange={onInputChange}
                            type="text"
                            className={`w-full min-w-0 px-2 py-1.5 lg:p-3 text-[11px] lg:text-sm rounded lg:rounded-lg border bg-slate-50 dark:bg-white/5 outline-none focus:border-blue-500 ${errors.guestLastName ? 'border-red-400' : 'border-slate-200 dark:border-white/10'}`}
                        />
