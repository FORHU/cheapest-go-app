...
describe('SupportWidget', () => {
    ...
    it('holds a stream only while the panel is open', async () => {
        // A stream per visitor per tab, for a panel nobody is looking at, is a connection
        // the server holds open for nothing.
        render(<SupportWidget />, { wrapper: Wrapper });
