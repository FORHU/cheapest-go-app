        ...
        {isMenuOpen && (
          ...
          >
            ...
            <motion.nav
              ...
              className="absolute right-0 inset-y-0 w-[min(320px,85vw)] bg-white/95 dark:bg-slate-900/95 backdrop-blur-md shadow-2xl flex flex-col"
            >
              {/* Drawer Header */}
              ...
              {/* Drawer Links */}
              <div className="flex-1 overflow-y-auto py-1" data-scrollable>
                <button
