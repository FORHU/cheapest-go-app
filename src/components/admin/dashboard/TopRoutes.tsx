...
export function TopRoutes({ routes }: TopRoutesProps) {
    ...
    return (
        <motion.div
            ...
            className="bg-white dark:bg-obsidian border border-slate-100 dark:border-white/10 rounded-[2.5rem] p-8 shadow-xl h-full flex flex-col group transition-all duration-500"
        >
