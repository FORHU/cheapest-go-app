...
CREATE FUNCTION public.get_revenue_stats(php_rate numeric DEFAULT NULL::numeric, p_brand text DEFAULT NULL::text) RETURNS json
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE result JSON;
BEGIN
...
--
-- Name: mint_chat_reference(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.mint_chat_reference() RETURNS text
    LANGUAGE sql
    AS $$
...
--
-- Name: update_support_conversations_updated_at(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.update_support_conversations_updated_at() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN NEW.updated_at = NOW(); RETURN NEW; END; $$;
...
CREATE TABLE public.bookings (
    ...
    fx_captured_at timestamp with time zone,
    fx_source text,
    booking_reference text
);
...
CREATE TABLE public.email_logs (
    ...
    CONSTRAINT email_logs_email_type_check CHECK ((email_type = ANY (ARRAY['confirmation'::text, 'ticketed'::text, 'refund'::text, 'cancellation'::text, 'awaiting_ticket'::text, 'price_alert'::text, 'support_escalation'::text]))),
...
CREATE TABLE public.hotel_content (
    ...
    room_groups_seeded_at timestamp with time zone,
    serp_filters text[] DEFAULT '{}'::text[] NOT NULL
);
...
--
-- Name: hotel_prebook_quotes; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.hotel_prebook_quotes (
...
--
-- Name: TABLE hotel_prebook_quotes; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TABLE public.hotel_prebook_quotes IS 'Server-side record of the supplier-quoted hotel price, keyed by prebookId. create-payment converts and charges from this row, not from the client payload.';


--
-- Name: COLUMN hotel_prebook_quotes.gross; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.hotel_prebook_quotes.gross IS 'Supplier total including taxes, in `currency`. This is the Stripe charge base.';


--
-- Name: COLUMN hotel_prebook_quotes.expires_at; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.hotel_prebook_quotes.expires_at IS 'Quotes are not chargeable past this instant — the underlying TGX rate has gone.';
...
--
-- Name: supplier_booking_attempts; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.supplier_booking_attempts (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    provider text NOT NULL,
...
--
-- Name: support_conversation_bookings; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.support_conversation_bookings (
...
CREATE TABLE public.support_conversations (
    ...
    status text DEFAULT 'waiting_human'::text NOT NULL,
    source_brand text,
    ...
    ai_turn_started_at timestamp with time zone,
    escalation_reason text,
    waiting_notified_at timestamp with time zone,
    reference text DEFAULT public.mint_chat_reference() NOT NULL,
    priority text,
    CONSTRAINT support_conversations_has_owner_check CHECK (((user_id IS NOT NULL) OR (guest_token_hash IS NOT NULL))),
    CONSTRAINT support_conversations_priority_check CHECK (((priority IS NULL) OR (priority = ANY (ARRAY['low'::text, 'normal'::text, 'high'::text, 'critical'::text])))),
    CONSTRAINT support_conversations_queued_is_answerable_check CHECK (((status <> ALL (ARRAY['waiting_human'::text, 'human_active'::text])) OR (user_id IS NOT NULL) OR ((guest_name IS NOT NULL) AND (guest_email IS NOT NULL)))),
    CONSTRAINT support_conversations_status_check CHECK ((status = ANY (ARRAY['ai_active'::text, 'waiting_human'::text, 'human_active'::text, 'resolved'::text])))
);


--
-- Name: support_message_attachments; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.support_message_attachments (
    ...
    CONSTRAINT support_message_attachments_agent_is_attributed_check CHECK (((uploaded_by_type <> 'agent'::text) OR (uploaded_by_admin_id IS NOT NULL))),
    CONSTRAINT support_message_attachments_size_check CHECK ((size_bytes > 0)),
    CONSTRAINT support_message_attachments_uploader_check CHECK ((uploaded_by_type = ANY (ARRAY['guest'::text, 'agent'::text])))
);


--
-- Name: COLUMN support_message_attachments.bytes_deleted_at; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.support_message_attachments.bytes_deleted_at IS 'When the object was removed from the bucket under the retention rule. The row survives so the transcript stays honest: NULL means the file is still fetchable, set means it was sent and has since expired.';
...
CREATE TABLE public.support_messages (
    ...
    CONSTRAINT support_messages_agent_is_attributed_check CHECK (((sender_type <> 'agent'::text) OR (sender_admin_id IS NOT NULL))),
    CONSTRAINT support_messages_notice_code_check CHECK (((notice_code IS NULL) OR (notice_code = ANY (ARRAY['budget_spent'::text, 'model_declined'::text, 'asked_for_person'::text, 'asked_for_person_out_of_hours'::text, 'assistant_unavailable'::text, 'model_failed'::text, 'details_needed'::text, 'assistant_retired'::text])))),
    CONSTRAINT support_messages_notice_is_system_check CHECK (((notice_code IS NULL) OR (sender_type = 'system'::text))),
    CONSTRAINT support_messages_sender_type_check CHECK ((sender_type = ANY (ARRAY['guest'::text, 'ai'::text, 'agent'::text, 'system'::text]))),
    CONSTRAINT support_messages_translation_not_system_check CHECK (((translated_body IS NULL) OR (sender_type <> 'system'::text)))
);
...
--
-- Name: COLUMN unified_bookings.fx_rate; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.unified_bookings.fx_rate IS 'USD per 1 unit of this booking''s currency, captured when payment was taken. Never recalculated.';


--
-- Name: COLUMN unified_bookings.fx_source; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.unified_bookings.fx_source IS 'live = rate provider at booking time; ecb-historical = backfilled at the true rate for the booking date; estimated = no historical source existed (VND/TWD/AED).';
...
CREATE TABLE public.users (
    ...
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    birth_date date,
    CONSTRAINT users_role_check CHECK ((role = ANY (ARRAY['user'::text, 'admin'::text, 'support_agent'::text])))
);
...
--
-- Name: hotel_prebook_quotes hotel_prebook_quotes_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.hotel_prebook_quotes
    ADD CONSTRAINT hotel_prebook_quotes_pkey PRIMARY KEY (prebook_id);
...
--
-- Name: supplier_booking_attempts supplier_booking_attempts_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.supplier_booking_attempts
    ADD CONSTRAINT supplier_booking_attempts_pkey PRIMARY KEY (id);


--
-- Name: support_conversation_bookings support_conversation_bookings_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.support_conversation_bookings
    ADD CONSTRAINT support_conversation_bookings_pkey PRIMARY KEY (conversation_id, booking_reference);


--
-- Name: support_conversations support_conversations_guest_token_hash_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.support_conversations
    ADD CONSTRAINT support_conversations_guest_token_hash_key UNIQUE (guest_token_hash);
...
--
-- Name: support_message_attachments support_message_attachments_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.support_message_attachments
    ADD CONSTRAINT support_message_attachments_pkey PRIMARY KEY (id);
...
CREATE UNIQUE INDEX bookings_booking_reference_key ON public.bookings USING btree (booking_reference) WHERE (booking_reference IS NOT NULL);


--
-- Name: bookings_usd_amount_created_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX bookings_usd_amount_created_idx ON public.bookings USING btree (created_at) WHERE (usd_amount IS NOT NULL);
...
--
-- Name: flight_bookings_booking_reference_key; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX flight_bookings_booking_reference_key ON public.flight_bookings USING btree (booking_reference) WHERE (booking_reference IS NOT NULL);


--
-- Name: flight_bookings_usd_amount_created_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX flight_bookings_usd_amount_created_idx ON public.flight_bookings USING btree (created_at) WHERE (usd_amount IS NOT NULL);
...
--
-- Name: hotel_content_serp_filters_gin; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX hotel_content_serp_filters_gin ON public.hotel_content USING gin (serp_filters);


--
-- Name: hotel_prebook_quotes_expires_at_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX hotel_prebook_quotes_expires_at_idx ON public.hotel_prebook_quotes USING btree (expires_at);
...
CREATE INDEX idx_support_conversations_queue ON public.support_conversations USING btree (status, last_message_at) WHERE (status <> 'resolved'::text);


--
-- Name: idx_support_conversations_user_open; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_support_conversations_user_open ON public.support_conversations USING btree (user_id, last_message_at DESC) WHERE ((user_id IS NOT NULL) AND (status <> 'resolved'::text));


--
-- Name: idx_support_message_attachments_message; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_support_message_attachments_message ON public.support_message_attachments USING btree (message_id);


--
-- Name: idx_support_message_attachments_unbound; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_support_message_attachments_unbound ON public.support_message_attachments USING btree (conversation_id, created_at) WHERE (message_id IS NULL);
...
CREATE INDEX idx_support_messages_conversation ON public.support_messages USING btree (conversation_id, created_at);
...
--
-- Name: supplier_booking_attempts_client_reference_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX supplier_booking_attempts_client_reference_idx ON public.supplier_booking_attempts USING btree (client_reference) WHERE (client_reference IS NOT NULL);


--
-- Name: supplier_booking_attempts_created_at_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX supplier_booking_attempts_created_at_idx ON public.supplier_booking_attempts USING btree (created_at DESC);


--
-- Name: supplier_booking_attempts_open_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX supplier_booking_attempts_open_idx ON public.supplier_booking_attempts USING btree (created_at DESC) WHERE (completed_at IS NULL);


--
-- Name: support_conversation_bookings_reference_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX support_conversation_bookings_reference_idx ON public.support_conversation_bookings USING btree (booking_reference);


--
-- Name: support_conversations_reference_key; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX support_conversations_reference_key ON public.support_conversations USING btree (reference);


--
-- Name: support_message_attachments_retention_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX support_message_attachments_retention_idx ON public.support_message_attachments USING btree (created_at) WHERE ((bytes_deleted_at IS NULL) AND (message_id IS NOT NULL));


--
-- Name: support_message_attachments_storage_key_key; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX support_message_attachments_storage_key_key ON public.support_message_attachments USING btree (storage_key);


--
-- Name: support_notes_conversation_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX support_notes_conversation_idx ON public.support_notes USING btree (conversation_id, created_at);


--
-- Name: unified_bookings_booking_reference_key; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX unified_bookings_booking_reference_key ON public.unified_bookings USING btree (booking_reference) WHERE (booking_reference IS NOT NULL);


--
-- Name: unified_bookings_usd_amount_created_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX unified_bookings_usd_amount_created_idx ON public.unified_bookings USING btree (created_at) WHERE (usd_amount IS NOT NULL);
...
CREATE TRIGGER trg_support_conversations_updated_at BEFORE UPDATE ON public.support_conversations FOR EACH ROW EXECUTE FUNCTION public.update_support_conversations_updated_at();
...
--
-- Name: support_conversation_bookings support_conversation_bookings_conversation_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.support_conversation_bookings
    ADD CONSTRAINT support_conversation_bookings_conversation_id_fkey FOREIGN KEY (conversation_id) REFERENCES public.support_conversations(id) ON DELETE CASCADE;


--
-- Name: support_conversation_bookings support_conversation_bookings_linked_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.support_conversation_bookings
    ADD CONSTRAINT support_conversation_bookings_linked_by_fkey FOREIGN KEY (linked_by) REFERENCES public.users(id) ON DELETE SET NULL;


--
-- Name: support_conversations support_conversations_assigned_admin_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.support_conversations
    ADD CONSTRAINT support_conversations_assigned_admin_id_fkey FOREIGN KEY (assigned_admin_id) REFERENCES public.users(id) ON DELETE SET NULL;
...
ALTER TABLE ONLY public.support_conversations
    ADD CONSTRAINT support_conversations_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id) ON DELETE SET NULL;


--
-- Name: support_message_attachments support_message_attachments_conversation_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.support_message_attachments
    ADD CONSTRAINT support_message_attachments_conversation_id_fkey FOREIGN KEY (conversation_id) REFERENCES public.support_conversations(id) ON DELETE CASCADE;


--
-- Name: support_message_attachments support_message_attachments_message_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.support_message_attachments
    ADD CONSTRAINT support_message_attachments_message_id_fkey FOREIGN KEY (message_id) REFERENCES public.support_messages(id) ON DELETE CASCADE;


--
-- Name: support_message_attachments support_message_attachments_uploaded_by_admin_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.support_message_attachments
    ADD CONSTRAINT support_message_attachments_uploaded_by_admin_id_fkey FOREIGN KEY (uploaded_by_admin_id) REFERENCES public.users(id) ON DELETE SET NULL;
...
--
-- Name: support_messages support_messages_sender_admin_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.support_messages
    ADD CONSTRAINT support_messages_sender_admin_id_fkey FOREIGN KEY (sender_admin_id) REFERENCES public.users(id) ON DELETE SET NULL;


--
-- Name: support_notes support_notes_author_admin_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.support_notes
    ADD CONSTRAINT support_notes_author_admin_id_fkey FOREIGN KEY (author_admin_id) REFERENCES public.users(id) ON DELETE RESTRICT;


--
-- Name: support_notes support_notes_conversation_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.support_notes
    ADD CONSTRAINT support_notes_conversation_id_fkey FOREIGN KEY (conversation_id) REFERENCES public.support_conversations(id) ON DELETE CASCADE;
